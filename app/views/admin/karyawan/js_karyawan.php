...
function getSelect() {
  $('[name="bagian"]').load("<?php echo site_url('getselect/pilih_mul/bagian/id_bagian/bagian')?>");
  $('[name="jabatan"]').load("<?php echo site_url('getselect/pilih_mul/jabatan/id_jabatan/jabatan')?>");
