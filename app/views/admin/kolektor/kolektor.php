              ...
              <div class="row">
                <form id="form" action="#" class="form-horizontal">
                    ...
                    <div class="col-lg-6 b-r">
                      <div class="form-group"><label class="col-lg-3 control-label ">Karyawan</label>
                          <div class="col-lg-9"><select name="id_karyawan" class="form-control"></select> <span class="help-block m-b-none"></span>
                          </div>
                      </div>
                      <div class="form-group"><label class="col-lg-3 control-label ">Wilayah</label>
                        <div class="col-lg-9"><select name="wilayah[]" class="multiSelect" multiple="multiple"></select> <span class="help-block m-b-none"></span>
                        </div>
                      </div>
                    </div>
