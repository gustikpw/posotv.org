            ...
            <div class="modal-body" id="step2">
              <div class="row">
                <form id="form" action="#" class="form-horizontal">
                    <input type="text" name="id_jenis_gangguan" hidden>
                    <div class="col-lg-12 b-r">
                      <div class="form-group"><label class="col-lg-2 control-label ">Jenis Gangguan</label>
                          <div class="col-lg-10"><input type="text" name="jenis_gangguan" placeholder="Jenis Gangguan" class="form-control fokus"> <span class="help-block m-b-none"></span>
                          </div>
                      </div>
        ...
        <div class="modal-content animated flipInY">
            ...
            <div class="modal-body">
              <div class="row">
                ...
                <tr>
                    <td class="font-bold">Jenis Gangguan</td>
