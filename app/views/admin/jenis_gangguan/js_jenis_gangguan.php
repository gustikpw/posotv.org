...
$(document).ready(function(){
  ...
  table = $('#table').DataTable({
    ...
    "ajax": {
        "url": "<?php echo site_url('jenis_gangguan/ajax_list')?>",
        "type": "POST"
    },
...
function save()
{
  ...
  var url;
  if(save_method == 'add') {
    url = "<?php echo site_url('jenis_gangguan/save_jenis_gangguan')?>";
  } else {
    url = "<?php echo site_url('jenis_gangguan/update_jenis_gangguan')?>";
  }
...
function edits(id)
{
  ...
  $('#form')[0].reset(); // reset form on modals
  $.ajax({
      url : "<?php echo site_url('jenis_gangguan/get_edit/')?>" + id,
      type: "GET",
      dataType: "JSON",
      success: function(data) {
        $('[name="id_jenis_gangguan"]').val(data.id_jenis_gangguan);
...
function deletes(id)
{
  ...
  {
    $.ajax({
      url : "<?php echo site_url('jenis_gangguan/delete_jenis_gangguan')?>/"+id,
      type: "POST",
      dataType: "JSON",
      success: function(data) {
...
function views(id)
{
  $.ajax({
      ...
      dataType: "JSON",
      success: function(data) {
        $('.v1').text(data.id_jenis_gangguan);
        $('.v2').text(data.jenis_gangguan);
