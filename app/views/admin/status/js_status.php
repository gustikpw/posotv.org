...
function save()
{
  ...
  var url;
  if(save_method == 'add') {
    url = "<?php echo site_url('status/save_status')?>";
  } else {
    url = "<?php echo site_url('status/update_status')?>";
  }
...
function edits(id)
{
  ...
  $('#form')[0].reset(); // reset form on modals
  $.ajax({
      url : "<?php echo site_url('status/get_edit/')?>" + id,
      type: "GET",
      dataType: "JSON",
      success: function(data) {
...
function deletes(id)
{
  ...
  {
    $.ajax({
      url : "<?php echo site_url('status/delete_status')?>/"+id,
      type: "POST",
      dataType: "JSON",
      success: function(data) {
