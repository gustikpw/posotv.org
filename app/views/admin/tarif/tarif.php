            ...
            <div class="modal-body" id="step2">
              <div class="row">
                <form id="form" action="#" class="form-horizontal">
                    <input type="text" name="id_tarif" hidden>
                    <div class="col-lg-12 b-r">
                      <div class="form-group"><label class="col-lg-2 control-label ">Kode Tarif</label>
                          <div class="col-lg-10"><input type="text" name="kode_tarif" placeholder="Kode Tarif" class="form-control fokus"> <span class="help-block m-b-none"></span>
                          </div>
                      </div>
                      <div class="form-group"><label class="col-lg-2 control-label ">Jumlah TV</label>
                          <div class="col-lg-10"><input type="number" name="jml_tv" placeholder="Jumlah TV" class="form-control"> <span class="help-block m-b-none"></span>
                          </div>
                      </div>
                      <div class="form-group"><label class="col-lg-2 control-label ">Tarif</label>
                          <div class="col-lg-10"><input type="number" name="tarif" placeholder="Tarif" class="form-control"> <span class="help-block m-b-none"></span>
                          </div>
                      </div>
        ...
        <div class="modal-content animated flipInY">
            ...
            <div class="modal-body">
              <div class="row">
                ...
                <tr>
                    <td class="font-bold">Kode Tarif</td>
                    <td class="font-bold v2"></td>
                </tr>
                <tr>
                    <td class="font-bold">Jumlah TV</td>
                    <td class="font-bold v3"></td>
                </tr>
                <tr>
                    <td class="font-bold">Tarif</td>
