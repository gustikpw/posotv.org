<html>
  <head>
    ...
    <link rel="stylesheet" href="<?php echo base_url('assets/instascan/style.css')?>">
    <script type="text/javascript" src="<?php echo base_url('assets/instascan/download/adapter.min.js') ?>"></script>
    <script type="text/javascript" src="<?php echo base_url('assets/instascan/download/vue.min.js') ?>"></script>
