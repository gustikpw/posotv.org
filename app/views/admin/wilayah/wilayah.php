              ...
              <div class="row">
                <form id="form" action="#" class="form-horizontal">
                    <div class="col-lg-12 b-r">
                      ...
                      <div class="form-group"><label class="col-lg-2 control-label ">Kode Wilayah</label>
                          <div class="col-lg-10"><input type="text" name="kode_wilayah" placeholder="Kode Wilayah" class="form-control fokus"> <span class="help-block m-b-none"></span>
                          </div>
                      </div>
                      <div class="form-group"><label class="col-lg-2 control-label ">Wilayah</label>
                          <div class="col-lg-10"><input type="text" name="wilayah" placeholder="Wilayah" class="form-control"> <span class="help-block m-b-none"></span>
                          </div>
                      </div>
