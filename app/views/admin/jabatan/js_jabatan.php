...
function save()
{
  ...
  var url;
  if(save_method == 'add') {
    url = "<?php echo site_url('jabatan/save_jabatan')?>";
  } else {
    url = "<?php echo site_url('jabatan/update_jabatan')?>";
  }
...
function edits(id)
{
  ...
  $('#form')[0].reset(); // reset form on modals
  $.ajax({
      url : "<?php echo site_url('jabatan/get_edit/')?>" + id,
      type: "GET",
      dataType: "JSON",
      success: function(data) {
...
function deletes(id)
{
  ...
  {
    $.ajax({
      url : "<?php echo site_url('jabatan/delete_jabatan')?>/"+id,
      type: "POST",
      dataType: "JSON",
      success: function(data) {
...
function views(id)
{
  $.ajax({
      ...
      dataType: "JSON",
      success: function(data) {
        $('.v1').text(data.id_jabatan);
        $('.v2').text(data.jabatan);
