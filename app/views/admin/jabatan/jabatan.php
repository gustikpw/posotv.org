            ...
            <div class="modal-body" id="step2">
              <div class="row">
                <form id="form" action="#" class="form-horizontal">
                    <input type="text" name="id_jabatan" hidden>
                    <div class="col-lg-12 b-r">
                      <div class="form-group"><label class="col-lg-2 control-label ">Jabatan</label>
                          <div class="col-lg-10"><input type="text" name="jabatan" placeholder="Jabatan" class="form-control fokus"> <span class="help-block m-b-none"></span>
                          </div>
                      </div>
